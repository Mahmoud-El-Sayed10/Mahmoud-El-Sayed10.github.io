        ...
        if (navLinksContainer) {
            if (userId) {
                navLinksContainer.innerHTML = `
                    <li><a href="Wallet - Client/dashboard.html"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                    <li><a href="Wallet - Client/profile.html"><i class="fas fa-user"></i> Profile</a></li>
                ...
                navLinksContainer.innerHTML = `
                    ...
                    <li><a href="Wallet - Client/register.html" class="btn primary-btn"><i class="fas fa-user-plus"></i> Sign Up</a></li>
                `;
            }
        }
    }
